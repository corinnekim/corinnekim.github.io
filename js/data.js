  ...
  ko: {
    ...
    intro: {
      ...
      paragraphs: [
        ...
        "미국 LA 인턴십 당시, 감으로 하던 기존 발주 방식을 SQL로 판매 데이터를 분석해 데이터 기반 의사결정으로 바꾼 경험이 데이터 사이언티스트가 되기로 한 계기입니다.",
        "경영학부에서 출발해 패션 산업을 거쳐 데이터 사이언스로 방향을 바꾸고, 네덜란드와 미국에서 낯선 환경에 빠르게 적응해 왔습니다. 선형대수, 통계학, 자료구조 등을 수강하며 수학과 CS 기초를 다졌습니다.",
        "낯선 도메인과 불완전한 데이터 속에서도 스스로 질문을 세우고 답을 찾아가는 과정을 즐깁니다. 끝까지 파고들어 나만의 인사이트를 찾아내는 데이터 사이언티스트가 되고 싶습니다."
      ]
    },
    titles: {
      education: "Education",
